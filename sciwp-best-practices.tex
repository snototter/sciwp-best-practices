...
An exception is the \emph{sentence case} where we use a full sentence as heading. To increase the readability here, we use standard capitalization rules: ``\goodstyle{How to give a good presentation?}'' or ``\goodstyle{An image is worth a thousand words.}''
\end{itemize}

\subsubsection*{Abbreviations:}
%TODO well-known abbrevations (GPS, CNN, ... - write abbrev first; explanation in parentheses), according to lebrun
\begin{itemize}
